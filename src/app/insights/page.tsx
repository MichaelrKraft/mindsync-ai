...
import { PatternDiscovery } from "@/components/ai/pattern-discovery";
...
type InsightFilter = 'all' | 'unread' | 'pattern' | 'connection' | 'summary' | 'suggestion';
        ...
        {insights.map((insight, index) => (
          ...
          >
            <InsightPanel
              ...
              showAnimation={index < 3} // Only animate first 3 for performance
            />
          </motion.div>
        ))}
      </AnimatePresence>
...
export default function InsightsPage() {
  ...
  const filteredInsights = useMemo(() => {
    ...
    // Sort by creation date (newest first) and unread status
  ...
  const handleContentSelect = (contentItem: any) => {
    ...
    // Here you could navigate to the content detail or perform other actions
  };

  return (
    <MainLayout>
      {/* Hero Section with BackgroundBeams */}
      <div className="relative h-[40rem] w-full bg-gradient-to-br from-mindsync-blue/10 via-white to-mindsync-green/10 flex flex-col items-center justify-center overflow-hidden">
        <div className="max-w-4xl mx-auto p-4 text-center relative z-10">
          <h1 className="text-4xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-mindsync-gray to-mindsync-gray-light mb-4">
            AI-Powered Insights
          </h1>
          <p className="text-mindsync-gray-light max-w-2xl mx-auto mb-6 text-lg">
            ...
            Our AI analyzes your content to reveal meaningful relationships and suggestions.
          </p>
      ...
      <div className="max-w-7xl mx-auto p-6 space-y-8">
        ...
        {viewMode === 'discovery' && (
          <div className="space-y-6">
            ...
            <PatternDiscovery
              connections={mockContentConnections}
              contentItems={mockContentItems}
              maxNodes={15}
            />
