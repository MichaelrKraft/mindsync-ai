⎿ "use client";                                                                         
    ...
    const NodeComponent = memo(({ 
      ...
      return (
        <motion.div
          className={cn(
            "absolute w-20 h-20 rounded-lg border-2 cursor-pointer transition-all 
    duration-200",
        ...
        >
          ...
          <div className="absolute -bottom-2 -left-2">
            <div className="w-5 h-5 bg-blue-500 text-white rounded-full flex items-center 
    ...
    export const PatternDiscovery = memo(({ 
      ...
      const [hoveredConnection, setHoveredConnection] = useState<ContentConnection |
    null>(null);
        ...
        <Card className={cn("p-4", className)}>
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-600">
              Visualizing {connectionLines.length} connections between {nodes.length}
    content items
            </p>
          </div>
